...
class TableServiceTest extends PostgreSQLContainerInitializer {
    ...
    void clearTables() {
        ...
        jdbcTemplate.execute("INSERT INTO card_status ( card_status_name) VALUES ('ACTIVE')");
        jdbcTemplate.execute("INSERT INTO card_status ( card_status_name) VALUES ( 'BLOCKED')");

        // Проверяем, что записи есть
        int countBefore = countRows("card_status");
        ...
        int countAfter = countRows("card_status");

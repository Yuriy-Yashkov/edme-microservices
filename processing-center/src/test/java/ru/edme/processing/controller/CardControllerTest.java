...
class CardControllerTest {
    ...
    void create() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/v1/processing-center/cards")
    ...
    void findById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/v1/processing-center/cards/{id}", id))
    ...
    void findAll() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/v1/processing-center/cards"))
                .andExpect(status().isOk())
    ...
    void update() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/v1/processing-center/cards")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRequest))
    ...
    void deleteShouldReturnOk() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/v1/processing-center/cards/{id}", id))
                .andExpect(status().isOk());

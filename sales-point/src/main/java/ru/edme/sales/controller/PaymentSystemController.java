...
@RequestMapping("v1/sales-point/payment-system")
...
public class PaymentSystemController {
    ...
    public ResponseEntity<PaymentSystemResponseDto> create(@Valid @RequestBody PaymentSystemRequestDto entity) {
        return ResponseEntity.status(HttpStatus.CREATED).body(paymentSystemService.save(entity));
    }
    ...
    public ResponseEntity<List<PaymentSystemResponseDto>> findAll() {
        return ResponseEntity.ok(paymentSystemService.findAllWrapped().getValues());
    }
    ...
    public ResponseEntity<PaymentSystemResponseDto> update(@Valid @RequestBody PaymentSystemRequestDto entity) {
        return ResponseEntity.status(HttpStatus.UPGRADE_REQUIRED).body(paymentSystemService.update(entity));
    }
    ...
    public ResponseEntity<Void> delete(@Parameter(description = "ID платежной системы", example = "1")
                                       @Positive
                                       @PathVariable("id") Long id) {
        boolean delete = paymentSystemService.delete(id);

...
public class CardController {
    ...
    public ResponseEntity<List<CardResponseDto>> findAll() {
        return ResponseEntity.ok(cardService.findAllWrapped().getValues());
    }
    ...
    public ResponseEntity<CardResponseDto> update(@Valid @RequestBody CardRequestDto cardRequestDTO) {
        return ResponseEntity.status(HttpStatus.UPGRADE_REQUIRED).body(cardService.update(cardRequestDTO));
    }
